package br.com.tonsantos.todolist.task;
...
import br.com.tonsantos.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity update(@RequestBody TaskModel taskModel, HttpServletRequest request,
        ...
        helper.copyNonNullProperties(taskModel, request);

        // estes serao passados pelo helper excluindo sua necessidade
        //
        // taskModel.setIdUser((UUID) idUser);
        // taskModel.setId(id);
